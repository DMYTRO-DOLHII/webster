...
const AnimatedText = () => {
    ...
    const before = morphText('McOkster');
    const after = morphText('Mc0k Universe');
    ...
    return (
        <div
            ...
            className="text-[#9b34ba] text-2xl font-bold cursor-pointer select-none whitespace-nowrap"
        >
